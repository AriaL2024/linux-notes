...
##  Day 5 - Chapter 5:Managing Hardware
...
The power supply converts the AC voltage to the DC voltage
What is the MotherBoard?

  > The MotherBoard(MainBoard) must communicate between each hardware components


The MotherBoard has a number of chips
Types of the chip on the motherboard:
  - Primary chips: They are used to connect the primary modules of system
